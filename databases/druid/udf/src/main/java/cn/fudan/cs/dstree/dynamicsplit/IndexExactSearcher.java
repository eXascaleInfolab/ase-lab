...
//        newRoot.printTreeInfo();
        ...
        while (timeSeriesReader.hasNext()) {
            ...
            totalTime.resume();
            PqItem result = exactSearch(queryTs, newRoot);
    ...
    public static int calcDistCount = 0;
    public static int leafCount = 0;
    public static StopWatch totalTime = new StopWatch();
    public static StopWatch ioTime = new StopWatch();
    public static StopWatch approTime = new StopWatch();

    public static PqItem exactSearch(double[] queryTs, Node root) throws IOException {
        leafCount = 0;
        calcDistCount = 0;
        ...
        approTime.suspend();
	System.out.println(approxNode.getFileName());
