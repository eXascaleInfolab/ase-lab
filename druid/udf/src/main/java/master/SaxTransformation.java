...
public class SaxTransformation {
	...
	public static List<Double> cuts_for_asize(int a_size) {
		switch(a_size) {
			...
			case 6: return new ArrayList<Double>(Arrays.asList(Double.NEGATIVE_INFINITY, -0.967421566101701, -0.430727299295457, 0.0, 0.430727299295457, 0.967421566101701));
			...
			case 8: return new ArrayList<Double>(Arrays.asList(Double.NEGATIVE_INFINITY, -1.15034938037601, -0.674489750196082, -0.318639363964375, 0.0, 0.318639363964375, 0.674489750196082, 1.15034938037601));			
			...
			case 10: return new ArrayList<Double>(Arrays.asList(Double.NEGATIVE_INFINITY, -1.2815515655446, -0.841621233572914, -0.524400512708041, -0.2533471031358, 0.0, 0.2533471031358, 0.524400512708041, 0.841621233572914, 1.2815515655446));
